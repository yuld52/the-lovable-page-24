    ...
    try {
      ...
      try {
        ...
        `, [
          ...
          'approved', // Auto-approve for now to ensure they show up
  ...
  async createSale(sale: any): Promise<any> {
    try {
      ...
      try {
        ...
        const result = await client.query(`
          INSERT INTO sales (checkout_id, product_id, user_id, amount, status, customer_email, paypal_order_id, paypal_capture_id, paypal_currency, paypal_amount_minor, created_at)
