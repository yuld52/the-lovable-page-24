    ...
    <div className="w-80 bg-background border-r border-border flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="px-4 py-2">
          <div className="bg-card/50 rounded-lg p-2 border-2 border-red-500/30 relative overflow-hidden group">
            <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
            <div className="relative flex items-center gap-2">
              <div className="w-10 h-10 flex-shrink-0 flex items-center justify-center bg-red-500/10 rounded-lg shadow-lg border border-red-500/20">
                  ...
                  <div className="flex-1 bg-muted/50 rounded-full h-1.5 overflow-hidden border border-border/50 relative">
                    <div 
                      ...
                      style={{ 
                        ...
                        background: `linear-gradient(90deg, #ef4444 0%, #ef4444 80%, #fca5a5 90%, #fecaca 100%)`
                      }}
                    >
                      <div 
                        className="absolute right-0 top-1/2 -translate-y-1/2 w-3 h-3 rounded-full bg-red-300 shadow-[0_0_8px_3px_rgba(239,68,68,0.7)]"
                      />
                    </div>
                  </div>
        ...
        <nav className="px-4 py-2 space-y-1">
          ...
          {/* Back to Regular User Panel */}
          <Link href="/dashboard">
            <button
              className="w-full flex items-center gap-4 px-4 py-3 rounded-xl font-bold transition-all duration-200 text-[15px] text-muted-foreground hover:text-foreground hover:bg-accent"
            >
              <LayoutDashboard size={18} strokeWidth={2.5} />
              Painel do Usuário
            </button>
