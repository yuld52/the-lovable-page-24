...
function StatusBadge({ status }: { status: string }) {
  ...
  if (status === "refunded") return (
    <div className="inline-flex items-center gap-1.5 bg-zinc-500/10 text-muted-foreground border border-zinc-500/20 px-2.5 py-1 rounded-full">
    ...
    <Layout title="Vendas" subtitle="Acompanhe suas transações em tempo real">
      ...
      <div className="flex flex-col md:flex-row gap-3 mb-6">
        ...
        <div className="w-full md:w-48">
          <Select value={statusFilter} onValueChange={setStatusFilter}>
            <SelectTrigger className="bg-muted/50 border-border h-11 text-sm">
        ...
        <Button
          ...
          className="bg-primary hover:bg-primary/90 text-primary-foreground border-0 h-11 px-5 rounded-xl flex items-center gap-2 font-semibold disabled:opacity-40"
        >
      ...
      {loadingSales ? (
        ...
        <Card className="bg-card border-border/60 flex flex-col items-center justify-center py-16 text-center">
          ...
          <h3 className="text-lg font-medium text-foreground mb-1">Nenhuma venda encontrada</h3>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border/60">
                  <th className="px-6 py-4 text-left text-[10px] font-bold text-muted-foreground uppercase tracking-wider">ID</th>
                  <th className="px-6 py-4 text-left text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Produto</th>
                  <th className="px-6 py-4 text-left text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Conta</th>
                  <th className="px-6 py-4 text-left text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Valor</th>
                  <th className="px-6 py-4 text-left text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Método</th>
                  <th className="px-6 py-4 text-left text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Status</th>
                  <th className="px-6 py-4 text-left text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Data</th>
                </tr>
              </thead>
                  ...
                  return (
                    <tr key={sale.id} className="hover:bg-accent/20 transition-colors group">
                      ...
                      <td className="px-6 py-4">
                        <span className="text-xs font-mono text-muted-foreground">{saleId}</span>
                      </td>
