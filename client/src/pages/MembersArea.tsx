...
export default function MembersArea() {
  return (
    <Layout title="Área de Membros" subtitle="Gerencie seus alunos e conteúdos">
      <Card className="bg-card border-border/60 flex flex-col items-center justify-center py-24 text-center">
        <div className="bg-muted p-6 rounded-full mb-6">
          <Construction className="w-12 h-12 text-purple-500" />
        </div>
        <h3 className="text-2xl font-bold text-foreground mb-2">Em Construção</h3>
